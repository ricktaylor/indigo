...
Indigo::Render::NinePatch::NinePatch(const glm::ivec2& position, const glm::u16vec2& size, const glm::vec4& colour, const OOBase::SharedPtr<Indigo::NinePatch::Info>& info) :
		UIDrawable(position),
		m_colour(colour),
		m_patch(-1),
		m_info(info)
