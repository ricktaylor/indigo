...
namespace Indigo
{
	...
	{
	public:
		UIImage(UIGroup* parent, const OOBase::SharedPtr<Image>& image, const glm::ivec2& position = glm::ivec2(0), const glm::uvec2& size = glm::uvec2(0), const glm::vec4& colour = glm::vec4(1.f));
